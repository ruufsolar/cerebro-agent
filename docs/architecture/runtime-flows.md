...
5. Slice 1's deterministic fake runner returns an explicit unknown result. Later slices
   replace this port with bounded Agents SDK execution and real tools.
