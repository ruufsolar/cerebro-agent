...
## Initial prompt skeleton for the live slice
...
This is a design seed, not yet the production prompt. Calibrate it with FinOps-labeled cases
and actual tool shapes in Slice 5.
