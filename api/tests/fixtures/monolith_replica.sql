...
CREATE TABLE vambe_message (id varchar PRIMARY KEY, "createdAt" timestamp NOT NULL, direction text NOT NULL, type text NOT NULL, content text, "phoneNumber" text NOT NULL, "channelPhoneNumber" text, "userId" uuid, status text, "stageId" uuid, "senderId" varchar);
...
INSERT INTO vambe_message VALUES ('synthetic-message-1', now(), 'inbound', 'text', 'Envié el comprobante del pago de 700000', '+56911111111', NULL, '00000000-0000-0000-0000-000000000001', 'sent', NULL, NULL);
